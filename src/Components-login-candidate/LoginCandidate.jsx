      ...
      <div className="lc-right-section">
        <form className="lc-login-form" onSubmit={handleLogin}>
          ...
          {view === "default" && (
            <>
              ...
              <div className="lc-input-group">
                ...
                {emailError && (
                  <span className="lc-error-text">{emailError}</span>
                )}
              </div>
              ...
              <div className="lc-input-group">
                ...
                {passwordError && (
                  <span className="lc-error-text password-error-msg">
                    {passwordError}
                  </span>
                )}
              </div>
              ...
              <div className="lc-options">
                ...
                <Link
                  to="/Resume-builder/login/forgotpassword"
                  className="lc-forgot-password"
                >
                  Forgot Password?
                </Link>
              </div>

              <button type="submit" className="lc-continue-btn">
                Continue
              </button>
            </>
          )}
          ...
          <p className="lc-contact-admin">
            ...
            <Link to="/Resume-builder/UserRegCandidate">Create Account</Link>
          </p>
        </form>
      </div>
    </div>
